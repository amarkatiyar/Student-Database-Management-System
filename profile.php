  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#band">search</a></li>
       <!-- <li><a href="#tour">SignUp</a></li>-->
        <li><a href="#Offer">INFORMATION</a></li>
...
<div id="band" class="container text-center">
  <h3>search</h3>
  <form class="form-horizontal" action="search_view.php" target="_blank" method="POST">
    <div class="form-group">
      <label class="control-label col-sm-2" for="f_name">First_Name:</label>
      <div class="col-sm-10">
...
<div id="tour" class="bg-1"> 
  ...
  <h3 class="text-center">INFORMATION</h3>
    <p class="text-center"></p>
	 <form class="form-horizontal" method="post" action="form_con.php" target="_blank">
	...
	<div class="form-group">
      ...
      <div class="col-sm-5">          
        <input type="varchar" class="form-control" id="mobile" name="mobile" placeholder="Enter Your Mobile No">
      </div>
    </div>
	<div class="form-group">
      <label class="control-label col-sm-2" for="course">course:</label>
      <div class="col-sm-9">          
        <input type="text" class="form-control"  id="course" name="course" placeholder="Enter Your course Name" >
      </div>
    </div>
	<div class="form-group">
      <label class="control-label col-sm-2" for="address">Temporary Address:</label>
      <div class="col-sm-9">          
        <input type="text" class="form-control"  id="address" name="address" placeholder="Enter Your Temporary Address" >
      </div>
    </div>
...
<!--<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4"> 
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span>Jorhat, Assam</p>
      <p><span class="glyphicon glyphicon-phone"></span>Phone: +91 1515151515</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: Mygmail@gmail.com</p>
    </div>
    <div class="col-md-8">
      <div class="row">
